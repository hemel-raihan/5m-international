    ...
    {{-- <div class="container-lg" style="background: #19a1dd;">
        <div class="container-md" style="background: white;"> --}}
            <div class="{{$page->container}}">
                <div class="main-div">
                    <footer id="foote" style="background: #19a1dd;">
                        {{-- <div style="background: #19a1dd;"> --}}
                            <!-- Footer Widgets
                            ============================================= -->
                ...
                <div id="copyright">
                    <div class="" style="background: #f7f7f7;">
                        ...
                        {{-- <div class="row col-mb-30">
                            ...
                            <div class="col-md-12 text-center text-md-start" style="color: #19a1dd;"> --}}
                                <p style="text-align: center; color: #19a1dd;">Copyrights &copy;
                                    Copyright 2017, 5M International Limited| All Rights Reserved | Powered by: datahostbd.com </p>
